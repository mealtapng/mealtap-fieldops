    ...
    return (
      <div className="min-h-screen bg-cream flex flex-col">
        <div className="max-w-md mx-auto w-full flex flex-col min-h-screen px-4 pt-12">
          <a href="/dashboard" className="inline-flex items-center gap-1 text-sm text-muted-brand mb-6">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center gap-3">
            ...
            <p className="text-sm text-muted-brand">Your supervisor hasn&apos;t assigned a zone yet. Check back soon.</p>
          </div>
        </div>
      </div>
    )
